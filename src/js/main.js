...
var showElementWithProps = function (element, titleText, contentText) {
...
var getCharacterAttributes = function (charCls, charRace, charGender) {
    if (charGender !== 'male' && charGender !== "female") {
        var gender_1 = func.randomBoolean();
